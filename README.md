...
|:----|:----|:----|:----|:----|:----|
| [設計・アーキテクチャ論](#設計・アーキテクチャ論) | [Azure 概論](#Azure概論) | Azure 標準化ガイドライン|tkanbara||[GitHub](https://github.com/Azure/Azure-standardization-guideline)|
...
|| [設計・開発方法論（一般）](#設計・開発方法論（一般）) |Azure CAF (超訳版) (2022/12 版)|nakama||[ppt](https://download.microsoft.com/download/2/a/b/2ab69a5d-7c69-4a24-a692-50823e3255d6/Translations_AzureCAF_v0.11.pptx) [YouTube (前半)](https://www.youtube.com/watch?v=eHLpPk6P8hw&t=10s) [YouTube (後半)](https://www.youtube.com/watch?v=RwAtcn75_7A&t=0s)|
|| [セキュリティ](#セキュリティ) |ゼロトラストセキュリティ|nakama|★★★|[ppt](https://download.microsoft.com/download/d/f/e/dfed7e7b-75e8-4939-823d-25a06b0abd68/FgCF_①_0_Zero_trust_type_multi_cloud_IT_environment_Introduction_Further_shortened_version_v0.40.pptx) [mp4](https://download.microsoft.com/download/b/5/0/b507ac40-280b-413a-be8a-56b29a6a765d/2020_03_10_FgCF_ZeroTrustMultiCloudITEnvironment_movie_v0.40a.zip) [YouTube](https://www.youtube.com/watch?v=T3bySEjhoQ8)|
...
|| [アプリ開発技術概論](#アプリ開発技術概論) |Web アプリ開発入門|hihorika||[YouTube](https://www.youtube.com/watch?v=OogiYJ4ogtY)|
...
|| [アプリ開発技術選択](#アプリ開発技術選択) |IaaS/CaaS/PaaS の使い分け|nakama|★|[ppt](https://aka.ms/AAj0yh3)|
...
|| [データ & AI 技術選択](#データ&AI技術選択) |データサービス技術選択|enishimu||[YouTube](https://www.youtube.com/watch?v=FL4t1aFrtVY)|
...
|| [OLTP 開発ノウハウ](#OLTP開発ノウハウ) |東西冗長構成|kodaisakabe||[YouTube](https://aka.ms/ocpjptbinf006)|
...
|| [AI/ML 開発ノウハウ](#AI/ML開発ノウハウ) |レコメンデーションシステム開発|nohanaga||[YouTube](https://aka.ms/ocpjptbdat067)|
|| [運用管理技術](#運用管理技術) |Web サービス運用ガイド|kodaisakabe||[YouTube](https://www.youtube.com/watch?v=2633bXz4tTU)|
...
|| [トレーニング](#トレーニング) |Microsoft Learn|odasho||[YouTube](https://aka.ms/ocpjptbetc002)|
|||Synapse Analytics & AI 自習方法|tfukuha||[YouTube](https://aka.ms/ocpjptbdat041)|
| [Azure テクノロジ](#Azureテクノロジ) | [セキュリティ](#セキュリティ) |Azure AD 入門|tfukuha||[YouTube](https://aka.ms/ocpjptbinf001)|
...
|| [インフラ](#インフラ) |Azure 物理インフラ|tokawa|★|[YouTube](https://aka.ms/ocpjptbinf007)|
|||インフラセキュリティ強化|tfukuha||[GitHub](https://github.com/Azure/jp-iaassecurity)|
|| [ネットワーク](#ネットワーク) |Azure ネットワーク概要|minaito||[YouTube](https://aka.ms/ocpjptbinf003)|
...
|| [マネージド NW サービス](#マネージドNWサービス) |サービス利用に必要な FQDN・ポート情報|hnakada||[Qiita](https://qiita.com/hisnakad/items/5a9f8157f62b959bc4be)|
|| [IaaS](#IaaS) |IaaS VM 入門|tfukuha|★★|[YouTube](https://aka.ms/ocpjptbdat009)|
...
|| [PaaS](#PaaS) |App Service 入門|tokawa|★|[YouTube](https://aka.ms/ocpjptbapp001)|
...
|| [ローコード開発](#ローコード開発) |Logic Apps|tfukuha|★|[YouTube](https://aka.ms/ocpjptbapp022)|
|| [ストレージ (DB)](#ストレージ\(DB\)) |SQL Database|nakama||→ App Service 資料を参照|
...
|| [ストレージ (NoSQL)](#ストレージ\(NoSQL\))|Cosmos DB|enishimu||[YouTube](https://aka.ms/ocpjptbdat003)|
|||Blob Storage|tfukuha||[YouTube](https://aka.ms/ocpjptbinf005)|
|| [データ分析](#データ分析) |Synapse Analytics|tfukuha||[YouTube](https://aka.ms/ocpjptbdat032)|
...
|| [データ移行・連携](#データ移行・連携) |Database Migration Service|kunisato||[YouTube](https://aka.ms/ocpjptbdat005)|
|||Qlik データ統合製品 + Synapse|naigaras||[YouTube](https://aka.ms/ocpjptbdat040)|
|| [AI/ML (Azure ML)](#AI/ML\(AzureML\)) |Azure ML : AutoML, Designer|tsmatsuz|★|[YouTube](https://aka.ms/ocpjptbdat068)|
...
||[AI/ML (Cognitive)](#AI/ML\(Cognitive\)) |LUIS, QnA Maker|nohanaga||[YouTube](https://aka.ms/ocpjptbdat073)|
...
|| [データ管理・ガバナンス](#データ管理・ガバナンス) |Purview|kunisato||[YouTube](https://www.youtube.com/watch?v=ZEAMM9qIn9k)|
|| [IoT / Edge](#IoT/Edge) |大量データストリーミング処理|tsmatsuz|★★|[YouTube](https://aka.ms/ocpjptbdat036)|
...
|| [開発技術](#開発技術) |Blazor, Static Web Apps|osamum||[YouTube](https://aka.ms/ocpjptbapp002)|
...
|| [DaaS](#DaaS) |AVD|nakama||[ppt](https://download.microsoft.com/download/7/0/4/7044dce5-224d-48ae-ab78-e25935e59b6f/WVD_Commentary_material_v0.19.pptx)|
|| [Multi/Hybrid](#Multi/Hybrid) |Azure Stack HCI|osamut||[YouTube](https://www.youtube.com/watch?v=VT2gJnMntTM)|
...
|| [運用管理](#運用管理) |Azure 運用管理サービス全体像|tfukuha|★|[YouTube](https://aka.ms/ocpjptbinf008)|
